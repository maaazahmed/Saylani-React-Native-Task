...
//         fetch("http://192.168.100.5:8000/getMyOrders", {
//             method: "post",
...
//     rejectOrder(data) {
//         console.log(data)
//         fetch("http://192.168.100.5:8000/rejectOrder", {
//             method: "post",
...
//     acceptOrder(data) {
//         console.log(data)
//         fetch("http://192.168.100.5:8000/acceptOrder", {
//             method: "post",
//             body: JSON.stringify(data),
//             headers: {
//                 'Accept': 'application/json',
...
// export default connect(mapStateToProp, mapDispatchToProp)(RequestComponent)
...
import PendingRequests from "./newOrders/index";
import AcceptOrders from "./AcceptedOrders/index";
...
export default class TabsAdvancedExample extends Component {
    render() {
        ...
        return (
            <Container>
                <Header style={{ backgroundColor: "#512da7" }} >
                    <Body style={{ marginLeft: 5 }} >
                        <Title>Orders</Title>
                    </Body>
                </Header>
                <Tabs tabBarUnderlineStyle={{ height: 2, backgroundColor: "#512da7" }} tabContainerStyle={{ width: "100%", alignSelf: "center", }}>
                    <Tab
                        activeTabStyle={{ backgroundColor: '#512da7' }}
                        tabStyle={{ backgroundColor: '#512da7' }}
                        activeTextStyle={{ color: "#fff" }}
                        textStyle={{ color: '#fff' }}
                        heading="Pending Orders">
                        <PendingRequests  navigation={this.props.navigation}/>
                    </Tab>
                    <Tab
                        activeTabStyle={{ backgroundColor: '#512da7' }}
                        activeTextStyle={{ color: "#fff" }}
                        ...
                        <AcceptOrders  navigation={this.props.navigation}/>
                    </Tab>
                </Tabs>
            </Container>
        );
